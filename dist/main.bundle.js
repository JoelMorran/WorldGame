...
var AllPlayersComponent = /** @class */ (function () {
    ...
    //constructor() { }
    AllPlayersComponent.prototype.getAllPlayers = function () {
        var _this = this;
        this.teamService.getAllPlayers().subscribe(function (temp) { return _this.allPlayerss = temp; });
    };
...
var CompetitionsComponent = /** @class */ (function () {
    ...
    CompetitionsComponent.prototype.getCompetitions = function () {
        var _this = this;
        this.teamService.getCompetitions().subscribe(function (temp) { return _this.competitionss = temp; });
    };
...
var HeadToHeadComponent = /** @class */ (function () {
    ...
    HeadToHeadComponent.prototype.getHeadToHead = function () {
        var _this = this;
        this.teamService.getHeadToHead().subscribe(function (temp) { return _this.headToHeads = temp; });
    };
...
module.exports = "\ntr, td {\n    text-align: center;\n    padding: 8px;\n}\n\ntr:nth-child(even){background-color: rgb(165, 165, 165)}\n\ntable {\n    border-collapse: collapse;\n    width: 100%;\n    height: 400px;\n    overflow-x:20px;\n    overflow-y:30px;\n    border-spacing: 0;\n    max-width: 100%;\n    max-height: 1000px;\n    display: block;\n}\n\ndiv { \n    overflow-y:auto;\n    overflow-x:auto;\n    \n    }"
...
var LeagueTableComponent = /** @class */ (function () {
    ...
    LeagueTableComponent.prototype.getLeagueTable = function () {
        var _this = this;
        this.teamService.getLeagueTable().subscribe(function (temp) { return _this.leagueTables = temp; });
    };
...
var MyTeamComponent = /** @class */ (function () {
    ...
    MyTeamComponent.prototype.getMyTeam = function () {
        var _this = this;
        this.teamService.getMyTeam().subscribe(function (temp) { return _this.myTeams = temp; });
    };
    MyTeamComponent.prototype.ngOnInit = function () {
        console.log("i'm running!");
        var game = this.getMyTeam();
...
var PerformanceComponent = /** @class */ (function () {
    ...
    PerformanceComponent.prototype.getPerformance = function () {
        var _this = this;
        this.teamService.getPerformance().subscribe(function (temp) { return _this.performances = temp; });
    };
...
var SeasonComponent = /** @class */ (function () {
    ...
    SeasonComponent.prototype.getSeason = function () {
        var _this = this;
        this.teamService.getSeason().subscribe(function (temp) { return _this.seasons = temp; }, function (err) { return console.log(err); }, function () { return console.log(_this.seasons); });
    };
